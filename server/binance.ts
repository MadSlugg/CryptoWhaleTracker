...
export class BinanceService {
   ...
   * @param minNotionalUSD Minimum USD value to be considered a whale order (default: $8.4M for 100+ BTC)
  ...
  async getWhaleOrders(minNotionalUSD: number = 8400000, referencePrice: number = 90000): Promise<OrderBookEntry[]> {
    try {
      ...
      const isValidTotal = (total: number): boolean => {
        return total >= 8400000 && total <= 100000000; // $8.4M to $100M (100+ BTC)
      };
